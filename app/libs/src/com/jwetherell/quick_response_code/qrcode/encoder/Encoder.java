...
public final class Encoder {
     ...
     */
    public static void encode(String content, ErrorCorrectionLevel ecLevel, QRCode qrCode) throws com.google.zxing.WriterException {
        encode(content, ecLevel, null, qrCode);
    }

    public static void encode(String content, ErrorCorrectionLevel ecLevel, java.util.Map<com.google.zxing.EncodeHintType, ?> hints, QRCode qrCode) throws com.google.zxing.WriterException {
        ...
        if (mode == Mode.BYTE && !DEFAULT_BYTE_MODE_ENCODING.equals(encoding)) {
            com.google.zxing.common.CharacterSetECI eci = com.google.zxing.common.CharacterSetECI.getCharacterSetECIByName(encoding);
            if (eci != null) {
        ...
        com.google.zxing.common.BitArray finalBits = new com.google.zxing.common.BitArray();
        ...
        if (!qrCode.isValid()) {
            throw new com.google.zxing.WriterException("Invalid QR code: " + qrCode.toString());
        }
    }
    ...
    private static int chooseMaskPattern(com.google.zxing.common.BitArray bits, ErrorCorrectionLevel ecLevel, int version, ByteMatrix matrix) throws com.google.zxing.WriterException {
     ...
     */
    private static void initQRCode(int numInputBits, ErrorCorrectionLevel ecLevel, Mode mode, QRCode qrCode) throws com.google.zxing.WriterException {
        ...
        throw new com.google.zxing.WriterException("Cannot find proper rs block info (input data too big?)");
    }
     ...
     */
    static void terminateBits(int numDataBytes, com.google.zxing.common.BitArray bits) throws com.google.zxing.WriterException {
        int capacity = numDataBytes << 3;
        if (bits.getSize() > capacity) {
            throw new com.google.zxing.WriterException("data bits cannot fit in the QR Code" + bits.getSize() + " > " + capacity);
        }
    ...
    static void getNumDataBytesAndNumECBytesForBlockID(int numTotalBytes, int numDataBytes, int numRSBlocks, int blockID, int[] numDataBytesInBlock,
            int[] numECBytesInBlock) throws com.google.zxing.WriterException {
     ...
     */
    static void interleaveWithECBytes(com.google.zxing.common.BitArray bits, int numTotalBytes, int numDataBytes, int numRSBlocks, com.google.zxing.common.BitArray result) throws com.google.zxing.WriterException {
        ...
        // vector with the
        // number.
        java.util.Collection<BlockPair> blocks = new java.util.ArrayList<BlockPair>(numRSBlocks);
        ...
        if (numTotalBytes != result.getSizeInBytes()) { // Should be same.
            throw new com.google.zxing.WriterException("Interleaving error: " + numTotalBytes + " and " + result.getSizeInBytes() + " differ.");
        }
    }
    ...
    static byte[] generateECBytes(byte[] dataBytes, int numEcBytesInBlock) {
        ...
        new com.google.zxing.common.reedsolomon.ReedSolomonEncoder(com.google.zxing.common.reedsolomon.GenericGF.QR_CODE_FIELD_256).encode(toEncode, numEcBytesInBlock);
     ...
     */
    static void appendModeInfo(Mode mode, com.google.zxing.common.BitArray bits) {
     ...
     */
    static void appendLengthInfo(int numLetters, int version, Mode mode, com.google.zxing.common.BitArray bits) throws com.google.zxing.WriterException {
     ...
     * the result in "bits".
     */
    static void appendBytes(String content, Mode mode, com.google.zxing.common.BitArray bits, String encoding) throws com.google.zxing.WriterException {
        switch (mode) {
        case NUMERIC:
    ...
    static void appendNumericBytes(CharSequence content, com.google.zxing.common.BitArray bits) {
    ...
    static void appendAlphanumericBytes(CharSequence content, com.google.zxing.common.BitArray bits) throws com.google.zxing.WriterException {
        int length = content.length();
        int i = 0;
        while (i < length) {
    ...
    static void append8BitBytes(String content, com.google.zxing.common.BitArray bits, String encoding) throws com.google.zxing.WriterException {
        byte[] bytes;
        try {
            bytes = content.getBytes(encoding);
        } catch (java.io.UnsupportedEncodingException uee) {
            throw new com.google.zxing.WriterException(uee.toString());
        }
        for (byte b : bytes) {
            bits.appendBits(b, 8);
        }
    ...
    static void appendKanjiBytes(String content, com.google.zxing.common.BitArray bits) throws com.google.zxing.WriterException {
        byte[] bytes;
        try {
            bytes = content.getBytes("Shift_JIS");
        } catch (java.io.UnsupportedEncodingException uee) {
    ...
    private static void appendECI(com.google.zxing.common.CharacterSetECI eci, com.google.zxing.common.BitArray bits) {
