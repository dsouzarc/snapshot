...
public abstract class ResultHandler {
    ...
    private final com.google.zxing.client.result.ParsedResult result;
    private final android.app.Activity activity;
    private final com.google.zxing.Result rawResult;

    ResultHandler(android.app.Activity activity, com.google.zxing.client.result.ParsedResult result) {
        this(activity, result, null);
    }

    ResultHandler(android.app.Activity activity, com.google.zxing.client.result.ParsedResult result, com.google.zxing.Result rawResult) {
        this.result = result;
        this.activity = activity;
        this.rawResult = rawResult;
    }

    public com.google.zxing.client.result.ParsedResult getResult() {
        return result;
    }
    ...
    public com.google.zxing.Result getRawResult() {
        return rawResult;
    }
