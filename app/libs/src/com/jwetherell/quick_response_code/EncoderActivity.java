 ...
 */
public final class EncoderActivity extends android.app.Activity {

    private static final String TAG = com.jwetherell.quick_response_code.EncoderActivity.class.getSimpleName();
    ...
    public void onCreate(android.os.Bundle bundle) {
        ...
        try {
            ...
            // smallerDimension);
            qrCodeEncoder = new QRCodeEncoder("Hello", null, Contents.Type.TEXT, com.google.zxing.BarcodeFormat.QR_CODE.toString(), smallerDimension);
            // qrCodeEncoder = new QRCodeEncoder("12345678910", null,
            // Contents.Type.TEXT, BarcodeFormat.UPC_A.toString(),
            // smallerDimension);

            android.graphics.Bitmap bitmap = qrCodeEncoder.encodeAsBitmap();
            android.widget.ImageView view = (android.widget.ImageView) findViewById(R.id.image_view);
            view.setImageBitmap(bitmap);

            android.widget.TextView contents = (android.widget.TextView) findViewById(R.id.contents_text_view);
            contents.setText(qrCodeEncoder.getDisplayContents());
            setTitle(getString(R.string.app_name) + " - " + qrCodeEncoder.getTitle());
        } catch (com.google.zxing.WriterException e) {
            android.util.Log.e(TAG, "Could not encode barcode", e);
