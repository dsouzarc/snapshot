...
public final class FinderPattern extends com.google.zxing.ResultPoint {
     ...
     */
    com.jwetherell.quick_response_code.qrcode.detector.FinderPattern combineEstimate(float i, float j, float newModuleSize) {
        ...
        return new com.jwetherell.quick_response_code.qrcode.detector.FinderPattern(combinedX, combinedY, combinedModuleSize, combinedCount);
    }
