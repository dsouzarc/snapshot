...
final class DataBlock {
     ...
     */
    static com.jwetherell.quick_response_code.qrcode.decoder.DataBlock[] getDataBlocks(byte[] rawCodewords, Version version, ErrorCorrectionLevel ecLevel) {
        ...
        // codewords
        com.jwetherell.quick_response_code.qrcode.decoder.DataBlock[] result = new com.jwetherell.quick_response_code.qrcode.decoder.DataBlock[totalBlocks];
        int numResultBlocks = 0;
        for (Version.ECB ecBlock : ecBlockArray) {
            for (int i = 0; i < ecBlock.getCount(); i++) {
                int numDataCodewords = ecBlock.getDataCodewords();
                int numBlockCodewords = ecBlocks.getECCodewordsPerBlock() + numDataCodewords;
                result[numResultBlocks++] = new com.jwetherell.quick_response_code.qrcode.decoder.DataBlock(numDataCodewords, new byte[numBlockCodewords]);
            }
        }
