...
public final class TelResultHandler extends ResultHandler {
    ...
    public TelResultHandler(android.app.Activity activity, com.google.zxing.client.result.ParsedResult result) {
    ...
    public CharSequence getDisplayContents() {
        ...
        return android.telephony.PhoneNumberUtils.formatNumber(contents);
    }
