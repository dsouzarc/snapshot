...
final class AlignmentPatternFinder {
     ...
     */
    AlignmentPatternFinder(com.google.zxing.common.BitMatrix image, int startX, int startY, int width, int height, float moduleSize, com.google.zxing.ResultPointCallback resultPointCallback) {
        this.image = image;
        this.possibleCenters = new java.util.ArrayList<AlignmentPattern>(5);
        this.startX = startX;
        this.startY = startY;
        this.width = width;
        this.height = height;
     ...
     *             if not found
     */
    AlignmentPattern find() throws com.google.zxing.NotFoundException {
