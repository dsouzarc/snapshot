...
public class FinderPatternFinder {
    ...
    public FinderPatternFinder(com.google.zxing.common.BitMatrix image, com.google.zxing.ResultPointCallback resultPointCallback) {
        this.image = image;
        this.possibleCenters = new java.util.ArrayList<FinderPattern>();
    ...
    protected java.util.List<FinderPattern> getPossibleCenters() {
        return possibleCenters;
    }

    FinderPatternInfo find(java.util.Map<com.google.zxing.DecodeHintType, ?> hints) throws com.google.zxing.NotFoundException {
    ...
    private float crossCheckVertical(int startI, int centerJ, int maxCount, int originalStateCountTotal) {
        com.google.zxing.common.BitMatrix image = this.image;
     ...
     */
    private FinderPattern[] selectBestPatterns() throws com.google.zxing.NotFoundException {
        ...
        if (startSize > 3) {
            ...
            java.util.Collections.sort(possibleCenters, new com.jwetherell.quick_response_code.qrcode.detector.FinderPatternFinder.FurthestFromAverageComparator(average));
        ...
        if (possibleCenters.size() > 3) {
            ...
            java.util.Collections.sort(possibleCenters, new com.jwetherell.quick_response_code.qrcode.detector.FinderPatternFinder.CenterComparator(average));
     ...
     * </p>
     */
    private static class FurthestFromAverageComparator implements java.util.Comparator<FinderPattern>, java.io.Serializable {
     ...
     * </p>
     */
    private static class CenterComparator implements java.util.Comparator<FinderPattern>, java.io.Serializable {
